...
//
///**
// * Legacy Turret Subsystem (encoder-based, preserved for reference).
// *
...
// *
// * @see TurretSubsystem for the current Limelight-based implementation.
// */
//@Config
//@Inject
//@HardwareScope
//class TurretSubsystemLegacy(factory: HardwareFactory) : Subsystem<TurretSubsystemLegacy.State, TurretSubsystemLegacy.Request>() {
//
//    companion object {
...
//    }
//
//    private val servos = factory.group<Servo>("turretServo0", "turretServo1") as ServoGroup
...
//            }))
//            .branch({ state: State -> state is TurretSubsystemLegacy.State.Targeting } as State, loop(exec {
//                val state = register.get() as TurretSubsystemLegacy.State.Targeting
