...
class ForwardTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetryM.addLine("Distance Moved: " + (follower.getPose().getX() - 72));
        ...
        telemetryM.addLine("Multiplier: " + (DISTANCE / ((follower.getPose().getX() - 72) / follower.getPoseTracker().getLocalizer().getForwardMultiplier())));
        telemetryM.update();
...
class LateralTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetryM.addLine("Distance Moved: " + (follower.getPose().getY() - 72));
        ...
        telemetryM.addLine("Multiplier: " + (DISTANCE / ((follower.getPose().getY() - 72) / follower.getPoseTracker().getLocalizer().getLateralMultiplier())));
        telemetryM.update();
